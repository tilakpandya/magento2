...
class Ccc_Vendor_Block_Adminhtml_Product_Attribute_Set_Main_Formset extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_name', array('legend'=> Mage::helper('vendor')->__('Edit Set Name')));
        $fieldset->addField('attribute_set_name', 'text', array(
            'label' => Mage::helper('vendor')->__('Name'),
            'note' => Mage::helper('vendor')->__('For internal use.'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select', array(
                'label' => Mage::helper('vendor')->__('Based On'),
                'name' => 'skeleton_set',
                'required' => true,
