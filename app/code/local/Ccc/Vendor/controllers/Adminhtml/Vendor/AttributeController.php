...
class Ccc_Vendor_Adminhtml_Vendor_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        parent::preDispatch();
        $this->_entityTypeId = Mage::getModel('eav/entity')->setType(Ccc_Vendor_Model_Vendor::ENTITY)->getTypeId();
    }
    ...
    protected function _initAction()
    {
        ...
        if($this->getRequest()->getParam('popup')) {
            ...
            $this->loadLayout()
                ->_setActiveMenu('vendor/attributes')
                ->_addBreadcrumb(Mage::helper('vendor')->__('vendor'), Mage::helper('vendor')->__('vendor'))
                ->_addBreadcrumb(
                    Mage::helper('vendor')->__('Manage Vendor Attributes'),
                    Mage::helper('vendor')->__('Manage Vendor Attributes'))
            ;
        }
        return $this;
